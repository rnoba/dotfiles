...
export OLLAMA_MODELS="$JUNK_PATH/ollama/models"
export OLLAMA_HOME="$JUNK_PATH/ollama"
export PATH="/home/rnoba/Documents/Programs/clangd/bin/:$PATH"
...
export NIX_PATH="$JUNK_PATH/nix-defexpr/channels"
