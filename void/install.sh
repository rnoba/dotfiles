...
readonly PACKAGES=(
	...
	# User applications
	rustup exa nix fzf gvfs thunar-volman Thunar xdg-user-dirs speech-dispatcher pavucontrol alacritty zsh tmux i3 i3blocks dmenu firefox feh mpv neovim flameshot
